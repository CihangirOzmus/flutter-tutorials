    ...
    return Drawer(
      child: Column(
        children: [
          ...
          buildDrawerOption(Icon(Icons.chat), 'Chat', () {}),
          buildDrawerOption(Icon(Icons.location_on), 'Map', () {}),
          buildDrawerOption(Icon(Icons.account_circle), 'Your Profil', () {}),
          buildDrawerOption(Icon(Icons.settings), 'Settings', () {}),
          Expanded(
            child: Align(
